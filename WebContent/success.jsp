...
#report th {url (header_bkg.png) repeat-x scroll center left;
	color: red;
	padding: 7px 15px;
	text-align: left;
}
...
#report tr.odd td {url (row_bkg.png) repeat-x scroll center left;
	cursor: pointer;
}
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand"
				href="${pageContext.request.contextPath}/login.jsp">Name and
				logo <img alt="Brand" src="..." class="thumbnails">
			</a>
		</div>
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown" role="button" aria-expanded="false">Courses
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown" role="button" aria-expanded="false">
						${sessionScope.userid} <span class="caret"></span>
				</a>
					<ul class="dropdown-menu" role="menu">
						<li><a
	...
	<table id="report" width="150" style="table-layout: fixed"
		align="justify">
		<tr>
	...
	<aside> <iframe id="video1" width="520" height="360"
		frameborder="0" allowfullscreen></iframe> <br>
	<a id="a" download style="visibility: hidden;"> download</a> </aside>
	<footer> <FONT COLOR=white>Copyright © Website.com <br></FONT>
	<a href=""><FONT COLOR=#66CCFF>Contact Us</FONT></a> </footer>
	<style>
body {
