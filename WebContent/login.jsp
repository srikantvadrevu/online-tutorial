...
<body>
	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand"
				href="${pageContext.request.contextPath}/login.jsp"><FONT
				COLOR=white>Name and logo</FONT> <img alt="Brand" src="..."
				class="thumbnails"></a>
		</div>
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				%>
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown" role="button" aria-expanded="false">${sessionScope.userid}
						<span class="caret"></span>
				</a>
					<ul class="dropdown-menu" role="menu">
						<li><a
	...
	<a href=""><FONT COLOR=#66CCFF>Contact Us</FONT></a>&nbsp;&nbsp;<a
		href=""><a href=""><FONT COLOR=#66CCFF>Sign Up?</FONT></a></footer>
	<style>
body {
